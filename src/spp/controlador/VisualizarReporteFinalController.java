 ...
 * Descripción: Controla la visualización y evaluación de un reporte final.
 */
import java.io.File;
...
public class VisualizarReporteFinalController implements Initializable {
    ...
    void clicAgregarObservacion(Event event) {
        ...
        UtilidadesGUI.mostrarGUI("/spp/vista/GUI-AgregarObservacionReporteFinal.fxml", event, "Agregar Observación");
    }

    @FXML
    void clicEvaluar(Event event) throws SQLException {
