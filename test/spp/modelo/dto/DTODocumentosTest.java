...
public class DTODocumentosTest extends TestCase {
    ...
    public void testReporteGettersSetters() {
        ...
        reporte.setFechaEntrega(fechaEntrega);
        reporte.setFechaEmision(fechaEmision);
        reporte.setRutaArchivo("C:/reportes/parcial.pdf");
        reporte.setIdPractica(12);
        reporte.setIdCatalogoDocumento(3);
        ...
        assertEquals(fechaEntrega, reporte.getFechaEntrega());
        assertEquals(fechaEmision, reporte.getFechaEmision());
        assertEquals("C:/reportes/parcial.pdf", reporte.getRutaArchivo());
        assertEquals(12, reporte.getIdPractica());
        assertEquals(3, reporte.getIdCatalogoDocumento());
    ...
    public void testEvaluacionConstructorCompleto() {
        LocalDate fecha = LocalDate.of(2026, 6, 18);
        PracticaProfesional practica = new PracticaProfesional();
        CatalogoEvaluacion catalogo = new CatalogoEvaluacion();

        Evaluacion evaluacion = new Evaluacion(2, 100, "Sin observaciones", fecha, practica, catalogo);

        assertEquals(2, evaluacion.getIdEvaluacion());
        assertEquals(100, evaluacion.getCalificacionNumerica());
        assertEquals("Sin observaciones", evaluacion.getObservaciones());
